...
ActiveRecord::Schema[7.0].define(version: 2023_09_05_010415) do
  ...
  create_table "tenant_connections", force: :cascade do |t|
    ...
    t.index ["tenant_id"], name: "index_tenant_connections_on_tenant_id"
  end
  ...
  add_foreign_key "tenant_connections", "tenants"
end
